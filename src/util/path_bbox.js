...
var pathToAbsolute = R.pathToAbsolute = R._pathToAbsolute = function (pathArray)
{
...
var path2curve = R.path2curve = R._path2curve = cacher(function (path, path2)
{
...
export default getBoundsOfPath;
